...
Understanding your skin undertone is essential for choosing the right foundation, concealer, jewelry, hair color, and seasonal palette.

However:

Most online undertone tools are locked behind paid beauty platforms
...
To build an accurate, explainable, and lighting-robust skin undertone classification system using:
...
Unlike quiz-based beauty tools, this analyzer:

Uses real pixel-level color extraction
